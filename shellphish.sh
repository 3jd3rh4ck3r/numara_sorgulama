#!/bin/bash
# ShellPhish v1.7
# Coded by: RAHİM_AKBAŞ (You dont become a coder by just changing the credits)
...
printf "\n"
printf "\e[1;93m       .:.:.\e[0m\e[1;77m Phishing Tool coded by:  @RAHİM_AKBAŞ \e[0m\e[1;93m.:.:.\e[0m\n"
printf "\n"
